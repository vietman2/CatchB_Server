...
urlpatterns = [
    ...
    path("comments/<int:pk>/like/", views.CommentLikeView.as_view(), name="comment_detail"),
    path("comments/<int:pk>/dislike/", views.CommentDislikeView.as_view(), name="comment_dislike"),
]
